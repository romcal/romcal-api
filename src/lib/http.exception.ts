...
export class HttpException extends Error {
   ...
   */
  constructor(private readonly response: string | object, private readonly status: number) {
    super();
  ...
  public static createBody(message: object | string, error?: string, statusCode?: number) {
    if (!message) {
